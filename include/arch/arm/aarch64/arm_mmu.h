...
#define PTE_BLOCK_DESC_NS		(1UL << 5)
#define PTE_BLOCK_DESC_AP_RO		(1UL << 7)
#define PTE_BLOCK_DESC_AP_RW		(0UL << 7)
#define PTE_BLOCK_DESC_NON_SHARE	(0UL << 8)
#define PTE_BLOCK_DESC_OUTER_SHARE	(2UL << 8)
#define PTE_BLOCK_DESC_INNER_SHARE	(3UL << 8)
#define PTE_BLOCK_DESC_AF		(1UL << 10)
#define PTE_BLOCK_DESC_NG		(1UL << 11)
#define PTE_BLOCK_DESC_PXN		(1UL << 53)
#define PTE_BLOCK_DESC_UXN		(1UL << 54)
